...
from components.stats import Stats, make_character_stats
...
weak_orc = CharacterTemplate(
        ...
        base_stats=make_character_stats(health=10),
...
strong_orc = CharacterTemplate(
        ...
        class_uid=warrior_class.uid,
        race_uid=orc_race.uid,
        base_stats=make_character_stats(health=16, strength=12, constitution=12),
        display=Display(Colors.ORC_GREEN, Colors.BLACK_COLOR, "O"),
        body_uid="humanoid",
        cumulative_level=2
    )
...
weak_troll = CharacterTemplate(
        ...
        base_stats=make_character_stats(health=24, strength=14, constitution=14),
...
human_warrior = CharacterTemplate(
        ...
        base_stats=make_character_stats(health=10, strength=12, constitution=12, dexterity=10),
...
human_thief = CharacterTemplate(
        ...
        race_uid=human_race.uid,
        base_stats=make_character_stats(health=6, constitution=10, dexterity=16),
        display=Display(Colors.WHITE_COLOR, Colors.BLACK_COLOR, "O"),
        body_uid="humanoid",
        cumulative_level=0
    )
